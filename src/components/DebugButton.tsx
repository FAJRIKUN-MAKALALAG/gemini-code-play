...
export const DebugButton = ({ code, lastError, onSendMessage, onSwitchToChat }: DebugButtonProps) => {
  ...
  const handleDebug = async () => {
    ...
    // Switch to chat view so user can see the response
    onSwitchToChat?.();

    // Small delay to let the view switch animate
