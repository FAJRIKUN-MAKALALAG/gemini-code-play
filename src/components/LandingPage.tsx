...
export const LandingPage = ({ onGetStarted }: LandingPageProps) => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      {/* Hero Section */}
      <section 
        className={`min-h-screen flex flex-col items-center justify-center p-6 text-center transition-all duration-1000 transform ${
      ...
      >
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary via-purple-500 to-blue-600 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          AI Code Play
        </h1>
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div 
              ref={featureRef1}
              className={`p-8 rounded-2xl bg-card border border-border/50 shadow-xl hover:shadow-2xl hover:border-primary/50 transition-all duration-700 transform ${
                feature1Visible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-20"
              }`}
            >
            ...
            <div 
              ref={featureRef2}
              className={`p-8 rounded-2xl bg-card border border-border/50 shadow-xl hover:shadow-2xl hover:border-primary/50 transition-all duration-700 delay-200 transform ${
                feature2Visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
              }`}
            >
            ...
            <div 
              ref={featureRef3}
              className={`p-8 rounded-2xl bg-card border border-border/50 shadow-xl hover:shadow-2xl hover:border-primary/50 transition-all duration-700 delay-400 transform ${
                feature3Visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-20"
              }`}
            >
